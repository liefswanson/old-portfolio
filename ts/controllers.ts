...
// 	export class CardListCtrl {
// 		public static $inject = ['$scope']

// 		constructor (private $scope: portfolio.ICardListScope) {
// 			$scope.cards = [
// 				{
// 					"id": "fruity-tetris",
...
// 	export class CardDetailCtrl {
// 		public static $inject = ['$scope'];

// 		constructor (private $scope: portfolio.ICardDetailsScope) {
// 			$scope.details = {
// 				"title": "Fruity Tetris: Food and Bricks Collide",
// 				"body": [
